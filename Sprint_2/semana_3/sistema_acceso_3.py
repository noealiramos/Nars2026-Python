...
#Fase 5: Acceso general y denegación
elif nivel_acceso >= 2 and en_horario:
    print(f"ACCESO CONCEDIDO — Empleado {empleado_id}: área general.")

elif not en_horario:
    print(f"ACCESO DENEGADO — Empleado {empleado_id}: fuera de horario laboral (8:00-20:00).")

else:
    print(f"ACCESO DENEGADO — Empleado {empleado_id}: nivel de acCESO DENE.")
    
print("Fin del proceso de validación de acceso.")
